...
public class BaseAttack : MonoBehaviour, IAttack
{
    ...
    [SerializeField] EnumCharacterAnimationStateName animationState;
    [SerializeField] EnumSoundName attackSoundEffect;
    ...
    { // Checks for objects on the enemy layer and if there is one in the area around the weapon , does damage
        Collider[] hit = Physics.OverlapSphere(attackPoint.position, 1f, enemy, QueryTriggerInteraction.Collide);
